...
function Footer() {
  return (
    <div className='w-full flex h-screen bg-zinc-900 p-20 text-white font-founders-grotesk'>
        <div className="w-1/2 flex flex-col justify-between h-full">
            <div className="heading">
                <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-15'>EYE-</h1>
                <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-15'>Opening</h1>
            </div>
        ...
        <div className="w-1/2">
            <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-15'>Presentaion
            </h1>
                <div className="dets font-neue-montreal  ">
                    <a className='block text-2xl font-light mt-2' href="#">Facebook</a>
                    <a className='block text-2xl font-light mt-2' href="#">Instagram</a>
                    <a className='block text-2xl font-light mt-2' href="#">Whatsapp</a>
                </div>
        </div>
    </div>
  )
